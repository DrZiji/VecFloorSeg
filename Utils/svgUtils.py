...
class PolygonWall(Wall):
    def __init__(self, e, id, shape=None):
        ...
        self.rr, self.cc = polygon(self.Y, self.X)  # 多边形中的坐标
    ...
    def sort_X_Y(self, X, Y):
        ...
        min_y = min(Y)
        res_X, res_Y = [0] * 4, [0] * 4
        # top left 0, top right 1, bottom left V2, bottom right 3
