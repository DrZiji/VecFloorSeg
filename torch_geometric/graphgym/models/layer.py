...
def new_layer_config(dim_in, dim_out, num_layers, has_act, has_bias,
    ...
    return LayerConfig(
        ...
        mem_inplace=cfg.mem.inplace, # 控制dropout操作是否为inplace
...
class GeneralLayer(nn.Module):
    ...
    self.layer: subclasses of MessagePassing
    self.post_layer: batchnorm + dropout + activation
    ...
    def __init__(self, name, layer_config: LayerConfig, **kwargs):
        ...
        for i in range(layer_config.num_layers):
            ...
            has_act = layer_config.final_act \
                if i == layer_config.num_layers - 1 else layer_config.has_act
